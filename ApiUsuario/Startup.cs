    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           .AddJwtBearer(x =>//incluido pra funcionar o jwt
           {
            ...
            services.Configure<UsuarioDatabase>(
               Configuration.GetSection(nameof(UsuarioDatabase)));

            services.AddSingleton<IUsuarioDatabase>(sp =>
                sp.GetRequiredService<IOptions<UsuarioDatabase>>().Value);

            services.AddSingleton<UsuarioServicos>();
